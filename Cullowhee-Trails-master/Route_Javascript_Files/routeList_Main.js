...
var mapListPageInfo = {};
mapListPageInfo.MapCenter_Lat = 35.309802;
mapListPageInfo.MapCenter_Long = -83.18352;
...
function drawPageHeader() {
    ...
    if (mapListPageInfo.CurrentPageView === "MAP") {
        ...
        $("#listPageTitle").html(categoryTitle.toUpperCase());
...
function loadCategoryPOIData() {
    ...
    var poiListID, fileURL;

    //Build url string
    poiListID = getQuerystring('qryCatCode');
    fileURL = "POI_Lists/POIList_" + poiListID + ".js";
    console.log("-----------LoadCategoryPOIData----------------");
