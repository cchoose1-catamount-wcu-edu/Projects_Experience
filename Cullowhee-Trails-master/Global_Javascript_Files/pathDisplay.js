...
function drawMap() {
    ...
    myParser.parse('KML/5k.kml');
    myParser.parse('KML/Intramurals.kml');
    myParser.parse('KML/Center_of_Campus.kml');
    myParser.parse('KML/Heart_of_Campus.kml');
    myParser.parse('KML/Track.kml');
    myParser.parse('KML/White_House_Loop.kml');
